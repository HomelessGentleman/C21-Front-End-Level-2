let myStr = "dit is een variabele van het datatype string"; //dit is een variabele van het datatype string, waarom? omdat er een zin in bevind vul je antwoord in op de lijn
let myInt = 3; //dit is een variabele van het datatype Intejure waarom? omdat er cijfers worden gebruikt vul je antwoorden in op de lijn

//Waarom staat er let voor de variabelen? voor een reeks van tekens vul je antwoord in op de lijn
